...
if ($resultado->num_rows > 0) {
    while($fila = $resultado->fetch_assoc()) {
      if($num%2!=0){
       ...
       echo "<li>";
       echo "<a>Cardio: ".$fila['Cardio']."</a>";
       echo "</li>";
       echo "<li>";
       echo "<a>Força: ".$fila['Forca']."</a>";
       echo "</li>";
       echo "<li>";
       echo "<a>Elasticitat: ".$fila['Elasticitat']."</a>";
       echo "</li>";
       echo "<li>";
       echo "<a>Experiencia: ".$fila['Experiencia']."</a>";
       echo "</li>";
       echo "<li>";
       echo "<a>Nocions Alimentaries: ".$fila['Nocions_alimentaries']."</a>";
       echo "</li>";
       echo "</ul>";
       echo "</div>";
       echo "</div>";
